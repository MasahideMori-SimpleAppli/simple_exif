...
class ExifFloatArray extends ExifDataType {
  final List<ExifFloat> value;

  /// * [value] : The data.
  ExifFloatArray(this.value) : super(EnumExifDataType.floatArray);
  ...
  ExifDataType deepCopy() {
    List<ExifFloat> r = [];
    for (ExifFloat i in value) {
      r.add(i.deepCopy() as ExifFloat);
    }
    return ExifFloatArray(r);
  }
}
